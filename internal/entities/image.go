...
type ImageService interface {
	...
	GetImages(ctx context.Context, post_id uuid.UUID, user_id uuid.UUID) ([][]byte, error)
	GetThumbnails(ctx context.Context, post_id uuid.UUID, user_id uuid.UUID) ([][]byte, error)
}
